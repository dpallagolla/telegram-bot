...
def message(bot, update):
    ...
    if(update.message.text == "uber"):
        bot.sendMessage(update.message.chat_id, text='wait dude, let me check!')  
        getUbers(bot)      
...
def getUbers(bot):
    bot.sendChatAction(chat_id=last_chat_id, action=telegram.ChatAction.LOCATION)
